...
`research/art/pixellab_style_guide.md`.** Read the palette and outline sections
before writing a prompt. Do not restate the style in your own words — append
the suffix below verbatim.
...
4. **Save** to `assets/sprites/icons/` (UI/ability) or `assets/sprites/items/`
   (world items), named `snake_case.png`.
