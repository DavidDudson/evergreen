...
**Tech Stack:** Rust, Bevy 0.18, the asset generator (particle sprites)
...
## Task 4: Generate Particle Sprites via the asset generator
...
All sprites use the `create_map_object` the asset generator tool.
